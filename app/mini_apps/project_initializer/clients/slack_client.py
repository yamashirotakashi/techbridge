...
class SlackClient:
    ...
    # Bot IDs (updated with correct User IDs discovered via diagnostic tool)
    TECHZIP_PDF_BOT_ID = "A097K6HTULW"  # TechZip PDF Bot (App ID as specified by user - ULTRATHINK corrected)
    INVITATION_BOT_ID = "A097NKP77EE"   # Invitation Bot for TechZip Bot (Application ID - requires separate handling)
